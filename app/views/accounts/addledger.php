    ...
    <table  class='table table-bordered table-condensed' style='font-size:12px'>
        ...
        <tr>
            ...
            <td>
                <select class="form-control subledger" name="subledger" required>
        ...
        <tr>
            ...
            <td><input type='text' class='form-control' name='openingbalance' /></td>
        </tr>

        <tr>
            <td>Balance Date</td>
            <td><input type='text' class='form-control alldate' name='openbalancedate'/></td>
        </tr>
